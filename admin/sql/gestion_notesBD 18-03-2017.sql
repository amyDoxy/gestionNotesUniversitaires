...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 23 Mars 2017 à 05:53
...
--
-- Structure de la table `udm_batch`
--

CREATE TABLE `udm_batch` (
...
(11, 'Electromechanical & Automation Engineering', 3),
...
(1, 'Faculté de Business et de Gestion'),
(2, 'Faculté des technologies de l’information et de communication'),
(3, 'Faculté de développement durable et d’ingéniorat'),
(4, 'Abc');
...
CREATE TABLE `udm_module` (
  ...
  `coeff_module` float(4,2) UNSIGNED DEFAULT NULL,
...
--
-- Index pour la table `udm_batch`
--
ALTER TABLE `udm_batch`
...
--
ALTER TABLE `udm_batch_module`
  MODIFY `id_batch_module` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `udm_batch_module`
  ADD CONSTRAINT `udm_batch_module_ibfk_1` FOREIGN KEY (`batch`) REFERENCES `udm_batch` (`batch`),
...
ALTER TABLE `udm_etudiant`
  ...
  ADD CONSTRAINT `udm_etudiant_ibfk_2` FOREIGN KEY (`batch`) REFERENCES `udm_batch` (`batch`);

--
-- Contraintes pour la table `udm_evaluation`
--
ALTER TABLE `udm_evaluation`
  ADD CONSTRAINT `udm_evaluation_ibfk_1` FOREIGN KEY (`id_module`) REFERENCES `udm_module` (`id_module`);
...
--
-- Contraintes pour la table `udm_module`
--
ALTER TABLE `udm_module`
  ADD CONSTRAINT `udm_module_ibfk_1` FOREIGN KEY (`id_dispensateur`) REFERENCES `udm_professeur` (`id_professeur`);
