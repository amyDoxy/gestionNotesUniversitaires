...
<?php
	...
	$stmt = $DB_con->prepare('SELECT id, surname, name, photos FROM client ');
	$stmt->execute();
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
			<div class="col-xs-3">
				<p class="page-header"><?php echo $surname."&nbsp;/&nbsp;".$name; ?></p>
				<img src="user_images/<?php echo $row['photos']; ?>" class="img-rounded" width="250px" height="250px" />
				<p class="page-header">
				<span>
